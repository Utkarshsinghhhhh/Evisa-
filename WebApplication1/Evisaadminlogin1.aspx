<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Evisaadminlogin1.aspx.cs" Inherits="WebApplication1.Evisaadminlogin1" %>
    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="textbox2" runat="server" CssClass="form-control" TextMode="Password" placeholder="Enter your password" required></asp:TextBox>
            </div>
